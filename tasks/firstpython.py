...
sfdmu_play_account_csv_filepath = os.path.abspath(os.path.join(sfdmu_play_folder, 'Account.csv'))
...
class YayForPython(BaseSalesforceApiTask):
    ...
    def _run_task(self):
        ...
        self.logger.info('Hello world' + ' ' + sfdmu_play_account_csv_filepath)